<template>
    <AppLayout>
        ...
        <!-- Modern Header -->
        <div class="bg-gradient-to-br from-gray-900 via-purple-900/20 to-blue-900/20 border-b border-gray-700/50">
            <div class="max-w-6xl mx-auto px-6 py-8">
                <!-- Header Content -->
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div class="space-y-3">
                        <div class="flex items-center gap-2 text-sm text-gray-400">
                            <a v-for="(breadcrumb, index) in breadcrumbs" :key="index" :href="breadcrumb.href" 
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <Button
                            ...
                            class="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3"
                        >
        ...
        <div class="max-w-6xl mx-auto px-6 py-8">
            <div class="space-y-8">
                ...
                >
                    <div v-if="showWizard" class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
                        <div class="w-full max-w-2xl bg-gray-800/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-gray-600/50">
                            <!-- Modal Header -->
                                ...
                                <form @submit.prevent="handleStepSubmit">
                                    ...
                                    <div v-show="currentStep === 1" class="space-y-6">
                                        ...
                                        <div v-else class="space-y-6">
                                            ...
                                            <div v-if="detectedEmbed" class="p-4 rounded-xl border border-purple-500/50 bg-purple-500/10">
                                                <div class="flex items-start gap-3">
                                                    ...
                                                    <div class="flex-1">
                                                        <h5 class="text-sm font-semibold text-purple-300 mb-1">Rich Media Detected!</h5>
                                                        <p class="text-sm text-gray-300 mb-3">
                                                            We detected this is a <strong>{{ detectedEmbed.platform }}</strong> link. Would you like to show it as an embedded preview?
                                                        </p>
                                                        <div class="flex items-center gap-3">
                                                            <button
                                                                type="button"
                                            ...
                                            <div v-if="!addForm.show_as_embed && addForm.type !== 'social'" class="space-y-2">
                                                ...
                                                <div class="relative">
                                                    ...
                                                    />
                                                    <div class="flex items-center gap-4 p-4 border-2 border-dashed border-gray-600 rounded-xl hover:border-blue-500/50 transition-colors">
                                                        <div v-if="imagePreview" class="flex items-center gap-3">
                                                            <img :src="imagePreview" alt="Preview" class="w-12 h-12 rounded-lg object-cover" />
                                                            <div class="flex-1">
                                                ...
                                                <p v-if="addForm.errors.image" class="text-sm text-red-400 flex items-center gap-1">
                                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                                                    </svg>
                                            ...
                                            <div class="p-4 rounded-xl border-2 border-dashed border-gray-600 bg-gray-700/30">
                                                <h5 class="text-sm font-medium text-gray-200 mb-3">Preview</h5>
                                                <div class="flex items-center gap-3">
                                                    <div class="w-12 h-12 rounded-xl flex items-center justify-center overflow-hidden flex-shrink-0"
                                                        ...
                                                        <img v-if="imagePreview" :src="imagePreview" alt="Link preview" class="w-full h-full object-cover" />
                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        ...
                                                        <div v-if="addForm.show_as_embed && detectedEmbed" class="flex items-center gap-1 mt-1">
                            ...
                            >
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center gap-4 flex-1 min-w-0">
                                        <!-- Icon -->
                                        <div class="flex h-12 w-12 items-center justify-center rounded-2xl flex-shrink-0 text-xl overflow-hidden"
                                             :class="link.image ? '' : getLinkIconStyle(link.type)">
                                            <img v-if="link.image" :src="'/storage/' + link.image" alt="Link image" class="w-full h-full object-cover" />
